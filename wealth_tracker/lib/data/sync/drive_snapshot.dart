...
/// Everything that gets synced across devices: assets, the debt ledger, and
/// counterparties. Deliberately excludes `price_cache` (re-fetched from live
/// APIs anyway) and `sync_meta` (local bookkeeping only).
